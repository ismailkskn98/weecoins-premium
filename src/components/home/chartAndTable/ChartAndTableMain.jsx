...
export default function ChartAndTableMain() {
  ...
  useEffect(() => {
    ...
    const chart = new Chart(ctx, {
      ...
      data: {
        labels: [
          t("chartAndTable.table.categories.circulation"),
  ...
  const distributionData = [
    { category: t("chartAndTable.table.categories.marketing"), amount: "60,000,000" },
    { category: t("chartAndTable.table.categories.projectSustainability"), amount: "60,000,000" },
    { category: t("chartAndTable.table.categories.teamAdvisor"), amount: "84,000,000" },
    { category: t("chartAndTable.table.categories.development"), amount: "21,600,000" },
    ...
    <main className="pageSection w-full space-y-8">
      ...
      <section className="flex w-full flex-col items-center justify-center gap-8 lg:flex-row lg:items-start lg:justify-between">
        ...
        <article className="max-w-9/12 w-full rounded-lg border bg-white p-3 shadow-lg dark:border-gray-800 dark:bg-dark-ozelDark sm:max-w-full sm:p-6 lg:w-auto lg:min-w-[600px]">
          <h2 className="mb-0 text-center text-lg font-semibold text-foreground sm:mb-4 md:text-start">{t("chartAndTable.chartTitle")}</h2>
