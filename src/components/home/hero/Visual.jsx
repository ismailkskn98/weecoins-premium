...
export default function Visual() {
  ...
  // useGSAP(() => {
  //   // gsap.from(heroImagesContainer.current, {
  //   //   st
  //   // })
  // }, { scope: heroImagesContainer });
  ...
  return (
    <article ref={heroImagesContainer} className="relative flex w-full items-center justify-center px-6 lg:px-0 xl:w-auto 2xl:justify-end">
      ...
      <Image
        ...
        width={231}
        height={231}
        className="bottom-image absolute -bottom-52 right-0 z-20 hidden max-h-[200px] max-w-[200px] drop-shadow-2xl lg:inline xl:-bottom-[12.5rem] xl:-right-20 2xl:-bottom-52 2xl:-right-36 2xl:max-h-[231px] 2xl:max-w-[231px]"
      />
    </article>
  );
}
