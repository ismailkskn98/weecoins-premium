...
export default function Hero() {
  return (
    <main className="fluid gridContainer relative h-auto w-full pb-10 pt-40 lg:h-[830px] lg:pb-0 lg:pt-0">
      <div className="fluid absolute inset-0 -z-20 bg-[linear-gradient(10deg,_var(--color-gradient-f7cf68)_0%,_var(--color-light-eaeefe)_59%)] dark:bg-[linear-gradient(10deg,_var(--color-gradient-f7cf68)_0%,_var(--color-dark-0d0d0d)_59%)]"></div>
