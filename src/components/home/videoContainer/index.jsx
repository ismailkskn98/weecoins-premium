...
export default function VideoContainer() {
  ...
  return (
    <section className="video-container fluid gridContainer relative mt-10 flex flex-col items-center justify-center gap-y-8 pb-24 sm:mt-20 md:mt-24 lg:gap-10 xl:mt-28">
